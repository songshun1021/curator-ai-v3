...
export function FileTree() {
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="border-b border-line-hair px-3 py-3">
        <div className="grid grid-cols-2 gap-2">
          <button
            type="button"
            className={`${compactFunctionalButtonClassName} w-full justify-center`}
      ...
      <CuratorDialog
        ...
        footer={
          <>
            ...
            <button type="button" className={compactPrimaryButtonClassName} onClick={() => void submitJobCreate()}>
              创建岗位
            </button>
          </>
        }
