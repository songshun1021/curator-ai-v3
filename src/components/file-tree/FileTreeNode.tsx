  ...
  return (
    <div className={depth > 0 ? "pl-4" : ""}>
      ...
      <CuratorDialog
        ...
        footer={
          <>
            <button type="button" className={compactSecondaryButtonClassName} onClick={() => setJobDialogOpen(false)}>
              取消
            </button>
            <button
              type="button"
      ...
      <CuratorDialog
        ...
        footer={
          <>
            <button type="button" className={compactSecondaryButtonClassName} onClick={() => setInterviewDialogOpen(false)}>
              取消
            </button>
            <button
              type="button"
      ...
      <CuratorDialog
        ...
        footer={
          <>
            <button type="button" className={compactSecondaryButtonClassName} onClick={() => setStatusDialogOpen(false)}>
              取消
            </button>
            <button
              type="button"
